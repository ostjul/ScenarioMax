...
class Scenario(dict):
    def __init__(self, *args, **kwargs):
        super(Scenario, self).__init__(*args, **kwargs)  # or super().__init__ in python3
        self.__dict__ = self

class Track(dict):
    def __init__(self, *args, **kwargs):
        super(Track, self).__init__(*args, **kwargs)  # or super().__init__ in python3
        self.__dict__ = self

class State(dict):
    def __init__(self, *args, **kwargs):
        super(State, self).__init__(*args, **kwargs)  # or super().__init__ in python3
        self.__dict__ = self
